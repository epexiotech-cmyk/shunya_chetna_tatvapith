...
class DBService {
  ...
  /// 🔐 REGISTER USER
  static Future<void> saveUserWithPassword(
    User firebaseUser,
    String password,
    String name,
  ) async {
    final existingUser = await getUserByEmail(firebaseUser.email ?? "");
  ...
  /// 🔐 LOGIN VERIFY
  static Future<UserModel?> verifyUserLogin(
    String email,
    String password,
  ) async {
