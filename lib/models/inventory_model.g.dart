...
int _inventoryModelEstimateSize(
  ...
  bytesCount += 3 + object.use.length * 3;
...
void _inventoryModelSerialize(
  ...
  writer.writeString(offsets[2], object.use);
...
InventoryModel _inventoryModelDeserialize(
  ...
  object.use = reader.readString(offsets[2]);
...
extension InventoryModelQueryFilter
  ...
  QueryBuilder<InventoryModel, InventoryModel, QAfterFilterCondition>
      useContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'use',
        value: value,
  ...
  QueryBuilder<InventoryModel, InventoryModel, QAfterFilterCondition>
      useMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'use',
        wildcard: pattern,
...
extension InventoryModelQuerySortBy
  ...
  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> sortByUse() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'use', Sort.asc);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> sortByUseDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'use', Sort.desc);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> sortByUserId() {
    return QueryBuilder.apply(this, (query) {
...
extension InventoryModelQuerySortThenBy
  ...
  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> thenByUse() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'use', Sort.asc);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> thenByUseDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'use', Sort.desc);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QAfterSortBy> thenByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }
...
extension InventoryModelQueryWhereDistinct
  ...
  QueryBuilder<InventoryModel, InventoryModel, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InventoryModel, InventoryModel, QDistinct> distinctByUse(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'use', caseSensitive: caseSensitive);
    });
  }

  QueryBuilder<InventoryModel, InventoryModel, QDistinct> distinctByUserId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension InventoryModelQueryProperty
  ...
  QueryBuilder<InventoryModel, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'type');
    });
  }

  QueryBuilder<InventoryModel, String, QQueryOperations> useProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'use');
    });
  }

  QueryBuilder<InventoryModel, String, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
