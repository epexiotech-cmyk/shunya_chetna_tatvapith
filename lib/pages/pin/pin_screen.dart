...
//                     /// 🔴 OLD PIN (ONLY FOR RESET)
//                     if (controller.isResetMode.value) ...[
//                       CustomText(text: "Enter Old PIN"),
//                       pinRow(context, controller.oldPinBoxes,
//                           controller.oldPinFocus),
//                       SizedBox(height: hp(2)),
//                     ],

//                     /// ENTER PIN
//                     CustomText(text: "Enter New PIN"),
...
//                     pinRow(context, controller.confirmBoxes,
              ...
              return Column(
                children: [
                  ...
                  if (controller.isSetMode.value ||
                    ...
                    /// OLD PIN (ONLY RESET)
                    if (controller.isResetMode.value) ...[
                      const CustomText(text: "Enter Old PIN"),
                      pinRow(context, controller.oldPinBoxes,
                          controller.oldPinFocus),
                      SizedBox(height: hp(2)),
                    ],

                    const CustomText(text: "Enter New PIN"),
                    pinRow(context, controller.pinBoxes, controller.pinFocus),

                    SizedBox(height: hp(2)),

                    const CustomText(text: "Confirm PIN"),
                    pinRow(context, controller.confirmBoxes,
                        controller.confirmFocus),
